...
transaction1 = blockchain.transaction('Mike', 'Satoshi', '5 ETH')
transaction2 = blockchain.transaction('Satoshi', 'Mike', '1 ETH' )
...
transaction4 = blockchain.transaction('Cindrella', 'Barbie', '7 ETH')
transaction5 = blockchain.transaction('Yale', 'Yuri', '2 ETH' )
